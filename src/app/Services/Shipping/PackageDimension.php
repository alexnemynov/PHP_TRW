...
{
    public function __construct(public readonly int $height, public readonly int $width, public readonly int $length)
    {
        match (true) {
    ...
    {
        return new self($this->height, $this->width + $width, $this->length);
    }
